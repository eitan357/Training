...
export const TRANSLATIONS = {
  ...
  he: {
    ...
    'privacy.reauth_details':         'מטעמי אבטחה, מחיקת חשבון דורשת התחברות טרייה. אמת/י את הזהות שלך כדי להמשיך. הנתונים שלך כבר נמחקו — ביטול הפעולה כאן לא ישחזר אותם.',
    ...
    'privacy.reauth_abandoned':       'הנתונים נמחקו, אך החשבון לא נמחק. יש לאמת מחדש כדי להשלים את מחיקת החשבון.',
    ...
    'err.user_mismatch':      'החשבון שאומת אינו החשבון המחובר כרגע',
  ...
  en: {
    ...
    'privacy.reauth_details':         'For security, deleting your account requires a fresh sign-in. Verify your identity to continue. Your data has already been deleted — cancelling here will not restore it.',
    ...
    'privacy.reauth_abandoned':       'Your data was deleted, but your account was not. Re-authenticate to finish deleting the account.',
    ...
    'err.user_mismatch':      'The verified account does not match the currently signed-in account',
